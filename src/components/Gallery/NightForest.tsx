  ...
  return (
    <div className="relative">
      ...
      <BoxShadow
        ...
        custom_style="absolute top-[10%] left-[42%] w-full text-5xl text-white z-50"
      >
      ...
      <BoxShadow
        ...
        custom_style="absolute bottom-[10%] left-[6%] w-full text-5xl text-white z-50 underline underline-offset-4"
      >
        <Link
          href={
